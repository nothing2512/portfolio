...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <!-- LOGO -->
    <tr>
        <td align="center" bgcolor="#EB5757">
    ...
    <tr>
        <td align="center" bgcolor="#EB5757" style="padding: 0px 10px 0px 10px;">
            <table border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;" width="100%">
                <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;"
                        valign="top">
                        <h1 style="font-size: 48px; font-weight: 400; margin: 2px; color: #000000">Selamat Datang!</h1>
                        <img alt="image" height="120" src=" https://img.icons8.com/clouds/100/000000/handshake.png"
